...
export class Event {
	...
	info() {
		return 'Manage events on the server, create, update, delete, etc.';
	}
}
...
export class CreateGeneralEvent {
	...
	async execute(
		...
		@SlashChoice({ name: 'Online', value: GuildScheduledEventEntityType.Voice} , {name: 'IRL', value: GuildScheduledEventEntityType.External})
		@SlashOption({
